<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="AdminUpdate.aspx.cs" Inherits="MyWebsite.AdminUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div dir="ltr" align="center" style="padding-top: 1%">
        ...
        <br />
        <br />
        <asp:TextBox runat="server" class="inputs" ID="password" placeholder="password" Style="margin-bottom: 5px; width: 15%"
            TextMode="Password" />
        <br />
        <asp:TextBox runat="server" class="inputs" ID="rePassword" placeholder="retype password"
            Style="margin-bottom: 5px; width: 15%" TextMode="Password" />
        <br />
